...
===============================================================================
Conrad - I have amended calcSegmentationErrors below to work with meshes in meters
"""
import logging
...
def calcSegmentationErrors(meshFileTest, meshFileGT, jacImgSpacing, gtScaling, testScaling):
    ...
    # I have changed the constants here from 10 to 0.1
    # The 10 is suitable when spacing is in units of mm
    # but causes a crash when things are in meters
    imgOrig = volMin - 0.1
